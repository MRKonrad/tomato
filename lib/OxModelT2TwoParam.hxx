...
//        return A - time*T2;
    ...
    ::calcLSJacobian(const MeasureType* parameters, MeasureType* jacobian){
        ...
        throw std::runtime_error("ModelT2TwoParam::calcLSJacobian has not been implemented");
    ...
    ::calcCostDerivative(const MeasureType* parameters, MeasureType* derivative){
        ...
        throw std::runtime_error("ModelT2TwoParam::calcCostDerivative has not been implemented");
