...
conan remove -\/f tomato conan create . cvi/production -\/s compiler.\+version=10.\+0 -\/e tomato\+:CC=\char`\"{}/opt/local/bin/clang-\/mp-\/10\char`\"{} -\/e tomato\+:C\+XX=\char`\"{}/opt/local/bin/clang++-\/mp-\/10\char`\"{} -\/s build\+\_\+type=Release 