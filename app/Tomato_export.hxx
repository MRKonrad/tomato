...
namespace Ox {
    ...
    ::exportT2ToDicom(){
        ...
        // T2 map with color
        DictionaryType dictionaryOutput_T2Color(_dictionaryInput);

        // UIDs
        gdcm::UIDGenerator sopuid;
        std::string sopInstanceUID_T2Color = sopuid.Generate();
        ...
        if (_opts->output_map_series_number == 0){
            ...
            // newSeriesNumber_T2 = std::to_string( stoi(seriesNumber) + 10002 ); // C++11 needed to do this
        } else {
        ...
        std::string ImageCommentsT2mapWithColormap, clutRedString, clutGreenString, clutBlueString;
        if (MagneticFieldStrength.find("1.5") != std::string::npos){
            ImageCommentsT2mapWithColormap = ImageCommentsT2mapWithColormap.append("T2");
        ...
        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2Color, std::string("0008|0018"), sopInstanceUID_T2Color);
        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2Color, std::string("0002|0003"), sopInstanceUID_T2Color);
        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2Color, std::string("0020|000e"), seriesUID_T2);
        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2Color, std::string("0028|1199"), PaletteColorLookupTableUID); // color look up table UID

        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2Color, std::string("0020|0011"), newSeriesNumber_T2); // series number

        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2Color, std::string("0020|4000"), ImageCommentsT2mapWithColormap); // series number
        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2Color, std::string("0020|0013"), std::string("1")); // instance number
//        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2Color, std::string("0028|0106"), std::string("0")); // smallest pixel
//        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2Color, std::string("0028|0107"), std::string("4096")); // largest pixel
//        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2Color, std::string("0028|1050"), std::string("2048")); // window center
//        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2Color, std::string("0028|1051"), std::string("4096")); // window width

        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2Color, std::string("0028|1101"), std::string("4096\\0\\16")); // red color look up table descriptor
        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2Color, std::string("0028|1102"), std::string("4096\\0\\16")); // green color look up table descriptor
        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2Color, std::string("0028|1103"), std::string("4096\\0\\16")); // blue color look up table descriptor

        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2Color, std::string("0028|1201"), clutRedString);
        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2Color, std::string("0028|1202"), clutGreenString);
        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2Color, std::string("0028|1203"), clutBlueString);
        ...
        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2, std::string("0020|4000"), std::string("T2 map")); // series number
        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2, std::string("0020|0013"), std::string("2")); // instance number
//        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2, std::string("0028|0106"), std::string("0")); // smallest pixel
//        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2, std::string("0028|0107"), std::string("4096")); // largest pixel
//        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2, std::string("0028|1050"), std::string("2048")); // window center
//        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2, std::string("0028|1051"), std::string("4096")); // window width
...
//        itk::EncapsulateMetaData<std::string>( dictionaryOutput_T2star, std::string("0020|4000"), std::string("Signal(TI)=A-B*exp(-TI/[___T2starMap___])")); // series number
        ...
        // _ShMOLLIT2range map
        DictionaryType dictionaryOutput_ShMolliT2Range(_dictionaryInput);

        std::string sopInstanceUID_ShMolliT2Range = sopuid.Generate();

        itk::EncapsulateMetaData<std::string>( dictionaryOutput_ShMolliT2Range, std::string("0008|0018"), sopInstanceUID_ShMolliT2Range);
        itk::EncapsulateMetaData<std::string>( dictionaryOutput_ShMolliT2Range, std::string("0002|0003"), sopInstanceUID_ShMolliT2Range);
        itk::EncapsulateMetaData<std::string>( dictionaryOutput_ShMolliT2Range, std::string("0020|000e"), seriesUID_R2);

        itk::EncapsulateMetaData<std::string>( dictionaryOutput_ShMolliT2Range, std::string("0020|0011"), newSeriesNumber_R2); // series number

        itk::EncapsulateMetaData<std::string>( dictionaryOutput_ShMolliT2Range, std::string("0020|4000"), std::string("_ShMOLLIT2range")); // series number
        itk::EncapsulateMetaData<std::string>( dictionaryOutput_ShMolliT2Range, std::string("0020|0013"), std::string("7")); // instance number
        itk::EncapsulateMetaData<std::string>( dictionaryOutput_ShMolliT2Range, std::string("0028|0106"), std::string("0")); // smallest pixel
        itk::EncapsulateMetaData<std::string>( dictionaryOutput_ShMolliT2Range, std::string("0028|0107"), std::string("4096")); // largest pixel
        itk::EncapsulateMetaData<std::string>( dictionaryOutput_ShMolliT2Range, std::string("0028|1050"), std::string("1500")); // window center
        itk::EncapsulateMetaData<std::string>( dictionaryOutput_ShMolliT2Range, std::string("0028|1051"), std::string("3000")); // window width
        ...
        if (!_opts->dir_output_map.empty()) {
            ...
            // export T2 color
            gdcmImageIO->SetMetaDataDictionary(dictionaryOutput_T2Color);

            // export to dicom
            adaptor->SetInput(OxColorbarFilter->GetOutput());
            writer->SetFileName(_opts->dir_output_map + KWUtil::PathSeparator() + newSeriesNumber_T2 + "_T2color.dcm");
        ...
        if (!_opts->dir_output_fitparams.empty()) {
            ...
            // export ShMolliRange
            gdcmImageIO->SetMetaDataDictionary(dictionaryOutput_ShMolliT2Range);
