/*!
 * \file Tomato_OriginalShmolliSameAsShmolli_test.cpp
 * \author Konrad Werys
 * \date 2018/08/20
 */
 ...
 */
class ActeptanceTests_TomatoFixtureTest_originalShmolli : public ::testing::Test {
...
protected:
    ...
    static void SetUpTestCase() {
        ...
        _tomato_object->_opts->parameter_to_map = Ox::T1_SHMOLLI_original;
...
Ox::Tomato<double>* ActeptanceTests_TomatoFixtureTest_originalShmolli::_tomato_object = NULL;
std::vector<std::string> ActeptanceTests_TomatoFixtureTest_originalShmolli::_originalFilePaths;
std::vector<std::string> ActeptanceTests_TomatoFixtureTest_originalShmolli::_calculatedFilePaths;

TEST_F(ActeptanceTests_TomatoFixtureTest_originalShmolli, OriginalShmolliSameAsShmolli_T1) {
...
TEST_F(ActeptanceTests_TomatoFixtureTest_originalShmolli, OriginalShmolliSameAsShmolli_R2) {
...
TEST_F(ActeptanceTests_TomatoFixtureTest_originalShmolli, OriginalShmolliSameAsShmolli_A) {
...
TEST_F(ActeptanceTests_TomatoFixtureTest_originalShmolli, OriginalShmolliSameAsShmolli_B) {
...
TEST_F(ActeptanceTests_TomatoFixtureTest_originalShmolli, OriginalShmolliSameAsShmolli_T1star) {
...
TEST_F(ActeptanceTests_TomatoFixtureTest_originalShmolli, OriginalShmolliSameAsShmolli_ShmolliRange) {
